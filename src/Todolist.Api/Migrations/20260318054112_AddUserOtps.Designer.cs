...
namespace Todolist.Api.Migrations
{
    ...
    [Migration("20260318054112_AddUserOtps")]
    partial class AddUserOtps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Todolist.Api.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Todolist.Api.Entities.Todo", b =>
                {
                    b.HasOne("Todolist.Api.Entities.ApplicationUser", "Owner")
                        .WithMany()
